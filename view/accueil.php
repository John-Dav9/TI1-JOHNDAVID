    ...
    <div class="page-wrapper">
        ...
        <main>
            <section class="contenu">
                ...
                <img src="img/armoiries_Copenhagen.svg.png" alt="Armoirie de Capenhagen" class="img-centree">
                <p>
                ...
                <ul class="sommaire">
                    ...
                    <li><a href="../?p=galerie" class="liens-utiles">Une galerie de photographie</a></li>
                    <li><a href="../?p=contact" class="liens-utiles">Un formulaire pour nous contacter</a></li>
                    <li><a href="../?p=liens" class="liens-utiles">Des liens vers les sites partenaires</a></li>
                </ul>
