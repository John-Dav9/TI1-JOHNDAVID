...
<body>
    ...
    <main>
        <section style="text-align: center; margin-top: 10vh;">
            ...
            <a href="../?p=geographie" class="liens-utiles">Explorer mes projets</a>
            <a href="../?p=histoire" class="liens-utiles">Explorer mes projets</a>
            <a href="../?p=culture" class="liens-utiles">Explorer mes projets</a>
            <a href="../?p=galerie" class="liens-utiles">Explorer mes projets</a>
            <a href="../?p=contact" class="liens-utiles">Explorer mes projets</a>
            <a href="../?p=liens" class="liens-utiles">Explorer mes projets</a>
